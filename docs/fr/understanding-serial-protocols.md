...
```
Ligne au repos ──┐                                        ┌── Ligne au repos
                 │ Start │ D0 D1 D2 D3 D4 D5 D6 D7 │ Stop │
                 └────────┴───────────────────────────┴───────┘
                   1 bit      8 bits de donnée      1 bit
```
...
```
┌─────────────────────────────────────────┐
│      JVS — adressage, commandes      │  ← protocole (contenu des octets)
├─────────────────────────────────────────┤
│  UART — trame Start / 8 bits / Stop  │  ← framing (forme des octets)
├─────────────────────────────────────────┤
│                RS-485                │  ← électrique (transport)
└─────────────────────────────────────────┘
```
...
```
Dalle tactile ADX ──▶ [paquets USB, "je suis un port série"] ──▶ Port COM virtuel
