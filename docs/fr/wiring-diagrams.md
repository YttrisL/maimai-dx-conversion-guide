...
* `MMT-1200` / `MMT-1700` **ASSY SW BASE 1P / 2P** — embases des boutons
* `837-15070-04` **IC BD LED DRV32CH RS232** ×2 — pilote de LEDs de boutons, un par joueur
...
* `MMT-1800-01` **ASSY BILLBOARD** — enseigne lumineuse du haut de la borne (`390-5768` **LED TAPE RGB**, `MMT-1080` haut-parleurs `130-5310`)
...
* `MMT-1350` / `MMT-1370` **ASSY PLAYER CAMERA / PLAYER CAMERA UNIT** — caméras joueurs (`601-13249` **CAMERA KBCR-S03MU-HPB2033-C300**), voir l'[étape 8](step-8-cameras.md)
* `MMT-1440` **ASSY AIME AND VFD** — module lecteur Aime (AIME RW UNIT) et afficheur (`200-6275` **VFD GP1232A02A FUTABA**), voir l'[étape 4](step-4-aime-reader.md)
* `MMT-1470` **ASSY CODE READER** — lecteur de QR code Aime (`601-13216-01` **USB CAMERA MS-M33NU2AMSH43-S2**)
* `MMT-1400` **ASSY CENTER TOWER** — tour centrale
* `MMT-1450` **ASSY ENTRY PANEL** — boutons de sélection joueur (`509-5970` **SW PB OBSF-24TR**)
* `MMT-1420` **ASSY SELECTOR DOOR** — sélecteur/tirelire (`220-5846-91-01` mécanisme accepteur de pièces, `220-5798-01` **MAG CNTR 4P MZ674** compteur de pièces)
...
* **ASSY LCD** — écran (`200-6226-91` **ASSY LCD DSPL 42 TYPE LED Y**)
...
* `MAI-1400` **ASSY COIN CHUTE TOWER** — tour centrale, avec `838-14971` **NFC RW BD TN32MSEC003S**, la carte du lecteur de carte Aime, voir l'[étape 4](step-4-aime-reader.md)
* `MAI-1420` **ASSY SELECTOR DOOR** (`220-5798-01` **MAG CNTR 4P MZ674**, compteur de pièces)
* `MAI-1460` **SW UNIT** (`838-14548-10` **SW & VOL BD**) — boutons test/service et volume
* `MAI-0500` **ASSY SPEAKER** — haut-parleurs (`838-15228` **2.1CH 40W STEREO AMP BD** ×2, `130-5296` caisson `130-5280` woofer)
...
* `837-14505` **I/O CONTROL BD FOR JVS** — la carte I/O (équivalent de l'IO4), voir l'[étape 3](step-3-io-board.md)
* **ASSY LCD** — écran côté 2P (`200-6226-91` **ASSY LCD DSPL 42 TYPE LED Y**)
* `837-15067-02` **IC BD USB TO 4SERIAL 232 IF** — le convertisseur Serial-USB mentionné à l'[étape 7](step-7-lighting.md) (zone F-2/G-2)
* `838-15221` **SERIAL I/F BD TOUCHPANEL GUNZE** — carte contrôleur de la dalle tactile Gunze
...
* `MAI-1200` / `MAI-1201` **ASSY SW BASE** — embase et disposition des 8 boutons (`838-15235-01` **LED BD RGB**, `370-5359` **PHOTO INTERRUPTER OJ-535S-A5**)
...
* `MAI-3100` **ASSY CAMERA SW RGLTR** (`400-5489-05012` **SW REGU VS50E-12**) — alimentation dédiée à la caméra
* `MAI-3000` **ASSY CAMERA BOX** — boîtier caméra (`838-15222` **MOVIE CAMERA CTRL BD**, `601-12827-01` **BD CAMERA KBCR-S01MG-HPB1022**), voir l'[étape 8](step-8-cameras.md)
* `MAI-3050` **ASSY LCD W/CUSHION** — petit écran de contrôle (`200-6211` **LCD MODULE NL6448BC18-01 NLT**)
