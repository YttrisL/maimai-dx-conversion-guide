...
!!! success "Bonne nouvelle"
    L'ordre des fils (pinout) sur le connecteur est presque identique à l'ancien modèle. Vous pouvez réutiliser les câbles de communication de l'ancien lecteur sans avoir à tout recâbler.
