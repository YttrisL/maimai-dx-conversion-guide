...
L'ordinateur *ALLS HX* possède 4 sorties audio classiques (type Jack). Trois sont situées sur la carte mère principale, et une sur une carte d'extension *([Manuel](pdfs/maimai-dx-manual-full.pdf), page 128)*.
...
Voici à quoi correspondent les ports audio de l'ordinateur : *(Voir [manuel](pdfs/maimai-dx-manual-full.pdf), page 193)*
...
Étape suivante (optionnelle) : les [Lumières](etape-7-lumieres.md).
