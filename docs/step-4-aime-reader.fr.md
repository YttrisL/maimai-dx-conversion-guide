...
**Sur le PC *ALLS HX* :** Le port matériel correspondant au COM1 est la prise série située à gauche des ports USB et de la prise réseau. *([Manuel](pdfs/maimai-dx-manual-full.pdf), page 128)*.
