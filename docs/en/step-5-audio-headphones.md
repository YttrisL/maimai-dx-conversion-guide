...
!!! tip "No need to buy amps with volume knobs"
    The headphone volume is set digitally, directly in the *DX* game menus.
...
Next step (optional): the [Lighting](step-6-lighting.md).
