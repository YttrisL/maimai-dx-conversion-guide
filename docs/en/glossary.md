...
* **Molex connector:** a type of power connector very common in computing, recognisable by its hard plastic housing (often white or black) and its thick pins. On the *RingEdge 2*, this is the connector through which 12V/5V/3.3V went to the rest of the cabinet.
