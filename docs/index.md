...
## Qu'est-ce que "DxNALE"
DxNALE est le nom donné par la communautés aux bornes maimai FiNALE converties afin de faire fonctionner maimai DX. En effet les deux systèmes sont radicalement différents, et il est strictement impossible de faire tourner DX sur une borne FiNALE dans son état d'origine.
...
!!! tip ""
    ...
    **Aucune modification logicielle du jeu n'est tolérée.** Le jeu doit "penser" qu'il tourne sur une borne originale Sega. Par conséquent, toute notre adaptation matérielle doit être invisible pour le jeu.
    ...
    L'avantage de cette approche est que la borne DxNALE obtenue est théoriquement compatible avec l'idéologie de la plupart des serveurs privés principaux pour maimai DX.

---

## Par où commencer ?

1. Lisez les [Avertissements](avertissements.md) pour comprendre les enjeux du projets et les conséquences de la modification.
2. Familiarisez-vous avec le [Lexique](lexique.md) afin de vous assurer de comprendre les termes employés par la suite.
3. Consultez la [Liste de courses](materiel.md), vous devez vous procurer chacun des éléments mentionnés.
4. Suivez les étapes de conversion dans l'ordre, en commençant par l'[Étape 1 : PC Central (ALLS)](etape-1-pc-alls.md).
5. Pour les détails techniques du pont tactile, référez-vous à l'annexe [Comprendre maitouch_rs](comprendre-maitouch_RS.md).
...
Prêt à vous lancer ? Commençons par les les [Avertissements](avertissements.md).