...
This repo contains the source for a documentation site, built with
...
free). This README walks you through getting it running on your own machine
from a completely clean install — no prior MkDocs experience assumed.
